...
GET	/{{products_id}}	Retrieve details of a single product using its ID
✅ Test Scenarios
...
Execute the Login request to generate an authentication token.
Run the remaining requests individually or use the Collection Runner to execute the complete workflow
